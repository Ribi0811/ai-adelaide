...
- Current production homepage = Business World (`components/home-studio/`), approved and deployed 2026-09-05 by Vercel CLI from `fc1c295`. Canonical-host browser and enquiry delivery checks passed. See `docs/SEO-RELEASE-2026-09-05.md`; no git push was performed.
