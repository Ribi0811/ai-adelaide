...
const suburb = "Mitcham";
const pageUrl = `https://aiadelaide.com.au/ai-automation-mitcham`;

export const metadata: Metadata = {
  title: `AI Automation for ${suburb} Small Businesses & Tradies | AI Adelaide`,
  description:
    `Local AI automation for tradies and small businesses in Mitcham. We answer missed calls, follow up quotes, and book jobs automatically so you stop leaking revenue.`,
  keywords: [
    "mitcham AI automation",
    "tradies mitcham",
    "AI receptionist mitcham",
    "small business automation mitcham",
  ],
  alternates: {
    canonical: `/ai-automation-mitcham`,
  },
};
    ...
    <main className="bg-white pb-16 pt-28 md:pb-24">
      ...
      <section className="section-shell px-6 md:px-8">
        <div className="mx-auto max-w-5xl sky-panel p-8 md:p-12">
          <p className="section-eyebrow">Mitcham AI automation services</p>
          <h1 className="section-title mt-4">
            AI Automation for Mitcham Small Businesses & Tradies
          </h1>
          <p className="mt-6 text-[17px] leading-8 text-[#4a607d] md:text-[19px]">
            Tradies and owner-operators in Mitcham are flat out on-site, then buried in admin after hours. If your calls, quote follow-ups, and booking messages are handled manually, leads slip through the cracks before you even get back to the ute.
          </p>
      ...
      <section className="section-shell px-6 py-12 md:px-8 md:py-16">
        <div className="mx-auto max-w-5xl sky-card p-8 md:p-12 text-[#3a4f6a]">
          <h2 className="text-3xl font-semibold tracking-[-0.03em] text-[#0c1930]">What we do for Mitcham businesses</h2>
          ...
          <h2 className="mt-10 text-3xl font-semibold tracking-[-0.03em] text-[#0c1930]">Why Mitcham tradies use automation now</h2>
          <p className="mt-5 leading-8">
            Most small teams in Mitcham do not have a dedicated admin person monitoring every channel all day. Calls come in while you are quoting, texts pile up during installs, and follow-up tasks sit in notebooks until the end of the week. This is exactly where revenue leakage happens.
          </p>
          ...
          <p className="mt-5 leading-8">
            We do not deliver generic templates and disappear. We map how your business currently wins work in Mitcham, then tailor the automation around that process. If your jobs come from Google, referrals, or repeat clients, we can design different follow-up paths for each channel.
          </p>
          <p className="mt-4 leading-8">
          ...
          <div className="mt-10 rounded-2xl border border-[#dce8f7] bg-[#f7fbff] p-6 md:p-8">
            ...
            <p className="mt-3 leading-7 text-[#4f647f]">
              We will review your current lead flow, identify the biggest automation opportunities, and give you a practical rollout plan for Mitcham.
            </p>
