...
// visible marketing string here is copied VERBATIM from the live page; only the
// presentation changed and animated demos were added (demos add UI chrome +
// numerals already stated in the copy, no new claims). Noindexed; delete = rm
// this dir. Two live-page bugs are intentionally NOT reproduced — see notes.
export const metadata: Metadata = {
  title: { absolute: "AI automation redesign preview | AI Adelaide" },
  description: "Internal design preview of the AI automation page re-skin.",
  robots: { index: false, follow: false },
  alternates: { canonical: "/ai-automation-preview" },
};
  ...
  return (
    <div className="bg-[#FBFBFD]">
      ...
      <p className="fixed bottom-4 left-4 z-50 rounded-full border border-black/10 bg-white/80 px-4 py-1.5 font-mono text-[11px] text-[#6B6B67] shadow-sm backdrop-blur">
        AI automation re-skin preview · not live
      </p>
