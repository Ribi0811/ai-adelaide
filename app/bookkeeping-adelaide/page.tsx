      ...
      <section className="max-w-container mx-auto px-6 pt-12 md:pt-16">
        <div className="panel-light p-6 md:p-8">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <Link href="/ai-office-worker-adelaide" className="rounded-xl border border-slate-200 bg-white p-4 text-sm font-semibold text-slate-900 hover:border-accent/40 hover:bg-accent/5">
              AI Office Worker Adelaide →
            </Link>
