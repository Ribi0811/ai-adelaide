...
// DESIGN PREVIEW — Phase D re-skin of /seo in the v4 language. RULE: every
// visible string is copied VERBATIM from app/seo/page.tsx (Ivan: "we are
// ranking well on those pages already" — words and metadata untouched). The
// RankLadder hero visual adds zero copy (skeleton bars + numerals only).
// Noindexed; delete = remove this dir.
export const metadata: Metadata = {
  title: { absolute: "SEO page redesign preview | AI Adelaide" },
  description: "Internal design preview of the SEO services page re-skin.",
  robots: { index: false, follow: false },
  alternates: { canonical: "/seo-preview" },
};
  ...
  return (
    <div className="bg-[#FBFBFD]">
      <p className="fixed bottom-4 left-4 z-50 rounded-full border border-black/10 bg-white/80 px-4 py-1.5 font-mono text-[11px] text-[#6B6B67] shadow-sm backdrop-blur">
        SEO page re-skin preview · not live
      </p>
