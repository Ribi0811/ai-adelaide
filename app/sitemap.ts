...
const PAGE_DATES: Record<string, string> = {
  ...
  "/local-seo-adelaide": "2026-09-08",
  "/affordable-web-design-adelaide": "2026-09-18",
  ...
  "/ai-app-development-adelaide": "2026-09-18",
  "/about": "2026-09-05",
  "/faq": "2026-06-20",
...
export default function sitemap(): MetadataRoute.Sitemap {
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    {
      url: `${siteConfig.url}/affordable-web-design-adelaide`,
      lastModified: dateFor("/affordable-web-design-adelaide"),
      changeFrequency: "weekly",
      priority: 0.9,
    },
    {
    ...
    {
      url: `${siteConfig.url}/quote-chaser-adelaide`,
      lastModified: dateFor("/quote-chaser-adelaide"),
      changeFrequency: "monthly",
      priority: 0.8,
    },
    {
