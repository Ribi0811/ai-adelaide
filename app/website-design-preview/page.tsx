...
// DESIGN PREVIEW — Phase D re-skin of /website-design-adelaide in the v4
// language. RULE: every visible string is copied VERBATIM from
// app/website-design-adelaide/page.tsx. One ADDITIVE module: <BuildYours />
// (the homepage's live build demo, reused with its own existing copy) — drop
// it if Ivan wants the page copy-pure. Noindexed; delete = remove this dir.
export const metadata: Metadata = {
  title: { absolute: "Website design redesign preview | AI Adelaide" },
  description: "Internal design preview of the website design page re-skin.",
  robots: { index: false, follow: false },
  alternates: { canonical: "/website-design-preview" },
};
...
export default function WebsiteDesignPreview() {
  return (
    <div className="bg-[#FBFBFD]">
      <p className="fixed bottom-4 left-4 z-50 rounded-full border border-black/10 bg-white/80 px-4 py-1.5 font-mono text-[11px] text-[#6B6B67] shadow-sm backdrop-blur">
        design-page re-skin preview · not live
      </p>
