...
const starterMessage: ChatMessage = {
  role: "assistant",
  content:
    "Hey — I’m the AI Adelaide chat assistant. I can help with websites, local SEO, quote follow-ups, and practical automation for Adelaide businesses. What sort of business are you running?",
};
...
export default function ChatWidget() {
  ...
  // Keep the enquiry and self-assessment journeys free of floating controls.
  if (pathname === "/contact" || pathname.startsWith("/audit")) return null;
      ...
      <div className="fixed bottom-4 right-4 z-[90] sm:bottom-6 sm:right-6">
          ...
          <div className="mb-3 h-[450px] w-[min(92vw,320px)] overflow-hidden rounded-[24px] border border-white/10 bg-slate-950 text-white shadow-[0_20px_80px_rgba(0,0,0,0.45)] transition-all duration-300">
            <div className="flex items-center justify-between border-b border-white/10 bg-slate-900/90 px-4 py-3">
              <div>
                ...
                <p className="text-xs text-slate-300">Websites, local SEO and automation</p>
              </div>
              <button
                type="button"
        ...
        <div className="flex flex-col items-end gap-2">
          ...
          <button
            ...
            className="flex min-w-[60px] items-center justify-center rounded-full border border-[#0C7A65]/20 bg-white px-4 py-3 text-sm font-semibold text-[#0C7A65] shadow-[0_6px_24px_rgba(29,29,31,0.12)] transition hover:scale-[1.03]"
