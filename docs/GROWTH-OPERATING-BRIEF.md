...
| P1 | Week of 7 September: channel map | Completed 9 September: source and live-browser journeys mapped; calculator report-email promise does not match its API, and requests are outside the Contact register. Ivan approved the scoped correction and existing-register collection extension on 9 September; implementation and local checks complete, production verification pending. See `reviews/2026-09-09/growth-operations/calculator-release.md`. |
