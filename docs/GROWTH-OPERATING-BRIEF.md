...
| P1 | Week of 7 September: channel map | Completed 9 September: source and live-browser journeys mapped; calculator report-email promise does not match its API, and requests are outside the Contact register. Scoped follow-up in `reviews/2026-09-09/growth-operations/channel-map.md`; collection extension remains unapproved. |
