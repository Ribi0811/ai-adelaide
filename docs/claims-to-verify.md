...
| `lib/constants.ts` | 145–173 (`caseStudies` array) | "Suburban Plumbing" / Dave S. — "47% more booked jobs in 90 days"; "Coastal Cafe" / Tom W. — "Page 1 ranking... weekend foot traffic is up 30%"; "Bright Smile Dental" / James L. — "No-shows dropped 65%, +$8k/month revenue" | Three case studies with specific plans, results, and quotes, reused across `/testimonials`, `/website-pricing` and `/ai-marketing-adelaide`. **RESOLVED 2026-07-17 (Ivan):** the business names were removed and replaced with anonymised descriptors ("Adelaide plumbing business", "Adelaide coastal cafe", "Adelaide dental clinic"). A named business paired with a specific financial outcome was the highest ACCC exposure on the site and was never permission-backed. Quotes, plans and result figures remain — if any of those figures are also unverified, flag separately. Do not reintroduce business names without written client consent. |
